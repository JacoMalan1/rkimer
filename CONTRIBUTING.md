...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a
   build.
2. Remove any build artifacts (e.g. build directory / .jar files) that aren't strictly part of the source
...
reported by contacting the project team at [jacomalan.12@gmail.com](mailto:jacomalan.12@gmail.com). All
